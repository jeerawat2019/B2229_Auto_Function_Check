...
namespace X_Core.Comp.SMLib.Flow
{
    ...
    public class SMDecision : SMFlowContainer
    {
        ...
        private void DoDestroy()
        {
            ...
            {
                X_CoreS.UnRegisterOnChanged(_propertyExpression, OnBoolPropertyChanged);
        ...
        private void DoRebuild()
        {
            lock (this)
            {
                ...
                if (_propWrapper != null && _propWrapper.Target is CompBase)
                {
                    ...
                    {
                        X_CoreS.RegisterOnChanged(_propertyExpression, OnBoolPropertyChanged);
        ...
        public override string ScopeCheck(string proposedScope)
        {
            ...
            if (lastPeriod < 0)
            {
                X_CoreS.LogPopup("Expected a period. {0}", ConditionID);
                return proposedScope;
            }
