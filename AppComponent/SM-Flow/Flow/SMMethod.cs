...
namespace X_Core.Comp.SMLib.Flow
{
    public class SMMethod : CompBase
    {
        ...
        {
            string scopeID = (Parent as SMActionFlow).ParentContainer.ScopeID;
            string prevScopeID = (Parent as SMActionFlow).ParentContainer.PrevScopeID;
        ...
        public string ScopeCheck(string proposedScope)
        {
            ...
            {
                X_CoreS.SplitMethodID(MethodID, out methodPath);
        ...
        private void RunAction()
        {
            try
            {
                ...
                X_CoreS.AddThread(_methodWrapper.MethodName);
                try
                {
                ...
                {
                    methodResults.Exception = new X_CoreExceptionAlert(ex, "Error running {0}", _methodWrapper.MethodName);
                }
                //int workerThreads = 0;
    ...
    public class MethodAsyncReturn
    {
        ...
        /// Exception if any
        /// </summary>
        public X_CoreException Exception { get; set; }
        /// <summary>
        /// Return value if any
        /// </summary>
