...
namespace X_Core.Comp.SMLib
{
    public class SMStateMachine : SMFlowContainer
    {
        ...
        [XmlIgnore]
        public bool SupervisorControl
        {
            get;
            set;
        }

        private int _deboundCount;
        [XmlIgnore]
        public int DeboundCount
        {
            [StateMachineEnabled]
            get
            {
                return this._deboundCount;
            }
            [StateMachineEnabled]
            set
            {
                this._deboundCount = value;
            }
        }

        private int _maxDeboundCount;
        [XmlIgnore]
        public int MaxDeboundCount
        {
            [StateMachineEnabled]
            get
            {
                return this._maxDeboundCount;
            }
            [StateMachineEnabled]
            set
            {
                this._maxDeboundCount = value;
            }
        }

        public bool IsDeboundReach
        {
            [StateMachineEnabled]
            get
            {
                return this._deboundCount >= this._maxDeboundCount ? true : false;
            }
        }
        ...
        {
            base.Initialize();
            this._deboundCount = 0;
            this._maxDeboundCount = 7;
...
#region Execution Command virtuals
        ...
        [StateMachineEnabled]
        public void ClearDeboundState()
        {
            this.DeboundCount = 0;
        }

        [StateMachineEnabled]
        public void IncrementDebound()
        {
            this.DeboundCount += 1;
        }
        ...
        {
            X_CoreS.AddThread("State Machine '{0}'", Text);
            try
            {
            ...
            {
                X_CoreS.LogPopup(ex, "State Machine '{0}' error", Text);
            }
            finally
            {
