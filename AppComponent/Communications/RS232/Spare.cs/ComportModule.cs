...
namespace AiComp.ConnectType
{
    public class Comport : CommuBase
    {
        ...
        private PortSetting _settings = null;
        ...
        public PortSetting SerSettings
        {
            get
            {
                return _settings;
        ...
        [Category("RS232")]
        [XmlIgnore]
        public PortSetting.eComport CommPort
        {
        ...
        [Category("RS232")]
        [XmlIgnore]
        public PortSetting.eBaudRate BaudRate
        {
        ...
        [Category("RS232")]
        [XmlIgnore]
        public PortSetting.eDataLength DataLength
        {
        ...
        [Category("RS232")]
        [XmlIgnore]
        public PortSetting.eNewLine NewLine
        {
        ...
        {
            get { return (int)(PortSetting.eBaudRate)_settings.BaudRate; }
        }
        ...
        public override void Initialize()
        {
            if (FullyDefined && !IsOpen)
            {
                ...
                {
                    X_CoreS.LogInfo(ex, "Failed to open {0}", Nickname);
                }
            }
            base.Initialize();
        }
        ...
        private void ClosePort()
        {
            lock (_lockPort)
            {
                if (_port != null)
                {
                    ...
                    {
                        X_CoreS.LogPopup(ex, "Unable to close Serial Port {0}", CommPort);
                    }
                }
            }
        }
        ...
        public void RefreshPort()
        {
            ...
            lock (_lockPort)
            {
                ...
                try
                {
                    ...
                    _port.Open();
                    X_CoreS.LogInfo("{0} finished opening port {1} port status = {2}", this.Nickname, CommPort, PortStatus);
                }
                catch (Exception ex)
                {
                    ClosePort();
