...
namespace MCore.Comp.MotionSystem
{
    ...
    public class IAIRS232Settings
    {
        ...
        /// Baud Rate
        /// </summary>
        private eBaudRate _baudRate = eBaudRate.BR115200;
        /// <summary>
        /// Data Length
        /// </summary>         
        ...
        public IAIRS232Settings(eComport commPort, eBaudRate baudRate)
        {
            _commPort = commPort;
            _baudRate = baudRate;
        }
