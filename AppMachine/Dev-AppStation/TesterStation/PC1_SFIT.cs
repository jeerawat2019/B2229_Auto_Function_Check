    ...
    public class PC1_SFIT : StationBase
    {
        ...
        public override bool IsStartProcess
        {
            ...
            get
            {
                X_CoreS.Delay(msec);
                ///
                if (Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews == null) return false;
                ///
                if (this.StationIndex < 0 || this.StationIndex > Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews.Length) return false;
                ///
                var part = Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex];
                ///
        ...
        public override bool IsTestting
        {
            ...
            get
            {
                ...
                if (this.StationIndex < 0 || this.StationIndex > Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews.Length) return false;
                ///
                return (Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.IsProcess
                    ///
        ...
        public bool IsPartFail
        {
            ...
            get
            {
                X_CoreS.Delay(msec);
                ///
                return !(Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.IsPass);
        ...
        {
            Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.Data2DCode = "";
            ///
            Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.IsProcess = AppMachine.AppResult.Part.Process.Null;
            ///
            Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.PartStatus = "NA";
        }
        ...
        {
            this.Data2Dcode = Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.Data2DCode;
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public void SetDisplayStatus(string process)
        {
            ...
            {
                case "E":
                    Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.IsProcess = AppMachine.AppResult.Part.Process.Empty;
                    break;
                case "T":
                    Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.IsProcess = AppMachine.AppResult.Part.Process.Testting;
                    break;
                case "F":
                    Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.IsProcess = AppMachine.AppResult.Part.Process.Finnish;
                    break;
                default:
                    break;
            }
        ...
        {
            Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.PartStatus = (this.PartResult == true) ? "OK" : "NG";
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            var strBin = Dev_AppMachine.Machine.This.PartJigColSfit1View.MemBinProcess;
            ///
            ...
            ///
            string strMem = string.Format("{0}{1}", "R", Dev_AppMachine.Machine.This.PartJigColSfit1View.MemControlPart.ToString());
            ///
            if (SetJigResultMemory(strMem, output.ToString()) != SequenceError.Normal)
            {
        ...
        public void SetConfirmResult()
        {
            ...
            if (part.CDPlayer.IsProcess == AppMachine.AppResult.Part.Process.Finnish)
            {
                ...
                var strMem = string.Format("{0}{1}", "R", Dev_AppMachine.Machine.This.PartJigColSfit1View.MemConfirmPart.ToString());
                ///
                ...
                ///
                this.BinToDecPartFinnish(charBin, Dev_AppMachine.Machine.This.PartJigColSfit1View.MemConfirmPart.ToString());
            }
        ...
        {
            string strResult = Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.PartStatus;
            ///
            string strMemResult = Dev_AppMachine.Machine.This.PartJigColSfit1View.PartJigViews[this.StationIndex].CDPlayer.MemResult.ToString();
            ///
