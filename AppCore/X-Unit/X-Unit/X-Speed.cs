...
namespace X_Unit
{
    ...
    /// </summary>
    public abstract class X_LengthSpeed : X_UnitBase
    {
        /// <summary>
        ...
        public X_LengthSpeed(double initialVal)
            :base(initialVal)
        {
        }
        /// <summary>
    ...
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<MicronsPerSecond>))]
    public class MicronsPerSecond : X_LengthSpeed
    {
        /// <summary>
        /// Serializing Constructor
        /// </summary>
        ...
        /// </summary>
        /// <param name="val"></param>
        public MicronsPerSecond(X_LengthSpeed val)
        {
        ...
        /// <returns></returns>
        public static MicronsPerSecond operator +(MicronsPerSecond val1, X_LengthSpeed val2)
        {
            MicronsPerSecond newVal = new MicronsPerSecond();
    ...
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<MillimetersPerSecond>))]
    public class MillimetersPerSecond : X_LengthSpeed
    {
        /// <summary>
        /// Serializing Constructor
        /// </summary>
        ...
        /// </summary>
        /// <param name="val"></param>
        public MillimetersPerSecond(X_LengthSpeed val)
        {
        ...
        /// <param name="val2"></param>
        /// <returns></returns>
        public static MillimetersPerSecond operator +(MillimetersPerSecond val1, X_LengthSpeed val2)
        {
            MillimetersPerSecond newVal = new MillimetersPerSecond();
    ...
    /// Nano-Meters (nm)
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<NanometersPerSecond>))]
    public class NanometersPerSecond : X_LengthSpeed
    {
        /// <summary>
        /// Serializing Constructor
        /// </summary>
        ...
        /// </summary>
        /// <param name="val"></param>
        public NanometersPerSecond(X_LengthSpeed val)
        {
            _val = val.ToMicronsPerSecond / MicronsPerUnit;
        }
        /// <summary>
        ...
        /// <param name="val2"></param>
        /// <returns></returns>
        public static NanometersPerSecond operator +(NanometersPerSecond val1, X_LengthSpeed val2)
        {
            NanometersPerSecond newVal = new NanometersPerSecond();
            newVal._val = (val1.ToMicronsPerSecond + val2.ToMicronsPerSecond) / newVal.MicronsPerUnit;
            return newVal;
    ...
    /// Base class for Length
    /// </summary>
    public abstract class X_RotarySpeed : X_UnitBase
    {
        /// <summary>
        /// Conversion factor to base value
        /// </summary>
        ...
        /// </summary>
        /// <param name="initialVal"></param>
        public X_RotarySpeed(double initialVal)
            : base(initialVal)
        {
        }
        /// <summary>
    ...
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<DegreesPerSecond>))]
    public class DegreesPerSecond : X_RotarySpeed
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="val"></param>
        public DegreesPerSecond(X_RotarySpeed val)
        {
        ...
        /// <param name="val2"></param>
        /// <returns></returns>
        public static DegreesPerSecond operator +(DegreesPerSecond val1, X_RotarySpeed val2)
        {
            DegreesPerSecond newVal = new DegreesPerSecond();
    ...
    /// DegreesPerSecond (deg/S)
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<RadiansPerSecond>))]
    public class RadiansPerSecond : X_RotarySpeed
    {
        /// <summary>
        /// Convert degrees to units
        /// </summary>
        ...
        /// </summary>
        /// <param name="val"></param>
        public RadiansPerSecond(X_RotarySpeed val)
        {
            _val = val.ToDegreesPerSecond / DegreesPerUnit;
        }
        /// <summary>
        ...
        /// <param name="val2"></param>
        /// <returns></returns>
        public static RadiansPerSecond operator +(RadiansPerSecond val1, X_RotarySpeed val2)
        {
            RadiansPerSecond newVal = new RadiansPerSecond();
            newVal._val = val1.ToDegreesPerSecond + val2.ToDegreesPerSecond;
            return newVal;
    ...
    /// CyclesPerSecond (hz)
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<CyclesPerSecond>))]
    public class CyclesPerSecond : X_RotarySpeed
    {
        /// <summary>
        /// Convert degrees to units
        /// </summary>
        ...
        /// </summary>
        /// <param name="val"></param>
        public CyclesPerSecond(X_RotarySpeed val)
        {
            _val = val.ToDegreesPerSecond / DegreesPerUnit;
        }
        /// <summary>
        ...
        /// <param name="val2"></param>
        /// <returns></returns>
        public static CyclesPerSecond operator +(CyclesPerSecond val1, X_RotarySpeed val2)
        {
            CyclesPerSecond newVal = new CyclesPerSecond();
            newVal._val = val1.ToDegreesPerSecond + val2.ToDegreesPerSecond;
            return newVal;
