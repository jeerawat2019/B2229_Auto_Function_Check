...
namespace X_Unit
{
    ...
    /// Base class for Time
    /// </summary>
    public abstract class X_Time : X_UnitBase
    {
        /// <summary>
        ...
        public X_Time(double initialVal)
            :base(initialVal)
        {
        }
        ///// <summary>
    ...
    /// Seconds (sec)
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<Miliseconds>))]
    public class Seconds : X_Time
    {
        /// <summary>
        /// Conversion factor to base value
        /// </summary>
        ...
        /// <returns></returns>
        public static Seconds operator +(Seconds val1, X_Time val2)
        {
            Seconds newVal = new Seconds();
    ...
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<Miliseconds>))]
    public class Miliseconds : X_Time
    {
        /// <summary>
        /// Conversion factor to base value
        /// </summary>
        ...
        /// <param name="val2"></param>
        /// <returns></returns>
        public static Miliseconds operator +(Miliseconds val1, X_Time val2)
        {
            Miliseconds newVal = new Miliseconds();
    ...
    /// Microseconds (ms)
    /// </summary>
    [TypeConverterAttribute(typeof(X_DoubleConverter<Microseconds>))]
    public class Microseconds : X_Time
    {
        /// <summary>
        /// Conversion factor to base value
        /// </summary>
        ...
        /// </summary>
        /// <param name="val"></param>
        public Microseconds(X_Time val)
        {
            _val = val.ToSeconds / SecondsPerUnit;
        }        
        /// <summary>
        ...
        /// <param name="val2"></param>
        /// <returns></returns>
        public static Microseconds operator +(Microseconds val1, X_Time val2)
        {
            Microseconds newVal = new Microseconds();
            newVal._val = (val1.ToSeconds + val2.ToSeconds) / newVal.SecondsPerUnit;
            return newVal;
