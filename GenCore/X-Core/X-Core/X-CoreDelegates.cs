...
namespace X_Core
{
    public static class D
    {
        ...
        public static GenericDelegateWithArgs CreateGenericDelegateWithArgs(MethodInfo method)
        {
            var instance = Expression.Parameter(typeof(object), "instance");
    ...
    public class PropDelegate<T> : PropDelBase
    {
        ...
        public PropDelegate(Expression<Func<T>> propertyLambda, MethodInvoker delOnChanged)
        {
            ...
            try
            {
                ...
                {
                    X_CoreS.RegisterOnChanged(propertyLambda, OnChanged);
                }
        ...
        public override void UnBind()
        {
            ...
            {
                X_CoreS.UnRegisterOnChanged(_propertyLambda, OnChanged);
            }
        }
